...
!function(){ColorThief.prototype.markBoomColors=function(o){for(var r=[],n=0;n<o.length;n++){var t=tinycolor({r:o[n][0],g:o[n][1],b:o[n][2]}),e=t.toHsv(),f=e.s+e.v;r.push([f,t,n])}for(var l=r.sort(function(o,r){return o[0]<r[0]?1:-1}),u=0;u<l.length;u++)o[l[u][2]].boomRank=u+1,o[l[u][2]].boomColor=0==u;return o}}();